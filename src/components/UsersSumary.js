...
export const UsersSummary = ({ userCount, usersTotal }) => { // export const UsersSummary = ({userCount,usersTotal})
  ...
  return (
    <div className="page-header">
      <div className="content-container">
        <h1 className="page-header__title">Viewing <span>{userCount}</span> {userWord} totalling <span>{formattedUsersTotal}</span></h1>
